...
const TUNINGS = [
	...
	{tuning: 'Drop D',	notes: ['E4', 'B3', 'G3', 'D3', 'A2', 'D2', 'B1', 'F#1']},
	{tuning: 'Drop C#',	notes: ['D#4','A#3','F#3','C#3','G#2','C#2','A#1','F1' ]},
	{tuning: 'Drop C',	notes: ['D4', 'A3', 'F3', 'C3', 'G2', 'C2', 'A1', 'E1' ]},
	{tuning: 'Drop B',	notes: ['C#4','G#3','E3', 'B2', 'F#2','B1', 'G#1','D#1']},
	{tuning: 'Drop A 7str',	notes: ['E4', 'B3', 'G3', 'D3', 'A2', 'E2', 'A1', 'F#1']},
	{tuning: 'Drop G 7str',	notes: ['D4', 'A3', 'F3', 'C3', 'G2', 'D2', 'G1', 'E1' ]}
];
...
const PACKS = [
	...
	{gauges: ['.0085 P','.011 P', '.015 P', '.022 W', '.030 W', '.040 W'], name: '.0085 Ernie Ball Mighty Slinky'},
	...
	{gauges: ['.0095 P','.012 P', '.016 P', '.024 W', '.034 W', '.044 W'], name: '.0095 Ernie Ball Primo Slinky'},
	{gauges: ['.0095 P','.012 P', '.016 P', '.026 W', '.036 W'. '.046 W'], name: '.0095 Ernie Ball Turbo Slinky'},
	{gauges: ['.010 P', '.013 P', '.017 P', '.026 W', '.036 W', '.046 W'], name: ".010 D'Addario / Ernie Ball", defaultSel: true},
	[gauges: ['.010 P', '.013 P', '.017 P', '.028 W', '.038 W', '.048 W'], name: '.010 Ernie Ball Ultra Slinky'},
	{gauges: ['.010 P', '.013 P', '.017 P', '.030 W', '.042 W', '.052 W'], name: ".010 D'Addario / Ernie Ball hybrid"},
	{gauges: ['.010 P', '.013 P', '.017 P', '.032 W', '.044 W', '.054 W'], name: '.010 Ernie Ball Skinny Top Beefy Bottom'},
	...
	{gauges: ['.0105 P','.0135 P','.0175 P','.028 W', '.038 W', '.048 W'], name: '.0105 Ernie Ball Mega Slinky'},
	{gauges: ['.0105 P','.0135 P','.0175 P','.030 W', '.042 W', '.052 W'], name: '.0105 Ernie Ball Mondo Slinky'},
	...
	[gauges: ['.011 P', '.014 P', '.018 P', '.030 W', '.042 W', '.052 W'], name: '.011 Ernie Ball Burly Slinky'},
	{gauges: ['.011 P', '.015 P', '.022 P', '.030 W', '.042 W', '.054 W'], name: '.011 Ernie Ball Beefy Slinky'},
	...
	{gauges: ['.012 P', '.016 P', '.024 W', '.034 W', '.048 W', '.062 W'], name: '.012 Ernie Ball Mammoth Slinky'},
	...
	{gauges: ['.011 P', '.014 P', '.018 P', '.028 W', '.038 W', '.048 W', '.058 W'], name: '.011 Ernie Ball Power Slinky 7'},
	...
	{gauges: ['.010 P', '.013 P', '.0165 P','.024 W', '.032 W', '.044 W', '.058 W', '.074 W'], name: '.010 Ernie Ball 8-String Regular Slinky'},
